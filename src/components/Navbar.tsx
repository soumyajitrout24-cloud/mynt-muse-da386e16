...
const Navbar = () => {
  ...
  return (
    <>
      <button
        onClick={openMenu}
        className={`fixed top-4 left-4 sm:top-5 sm:left-5 z-[220] flex h-11 w-11 items-center justify-center rounded-full border border-primary/30 bg-card/95 shadow-luxury backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-primary/60 ${
        ...
        {isOpen && (
          <>
            <motion.div
              ...
              className="fixed inset-0 z-[210] bg-background/75 backdrop-blur-sm"
              onClick={closeMenu}
            />
            ...
            <motion.nav
              ...
              className="fixed top-0 left-0 z-[215] flex h-full w-[320px] max-w-[88vw] flex-col border-r border-primary/25 bg-card px-7 pb-7 pt-20 shadow-luxury"
                  ...
                  return (
                    ...
                    >
                      <Link
                        to={link.path}
                        onClick={closeMenu}
                        className={`group flex items-center gap-3 py-2.5 font-elegant tracking-wider transition-all duration-300 ${
